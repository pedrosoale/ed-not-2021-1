...
let y = "populacao"
let x = "area"
let densidade = (x, y) => (y / x).toFixed(2)
...
vetorVazio.push(estadosNe[0].nome)
vetorVazio.unshift(estadosNe[1].nome)
vetorVazio.splice(1, 0, estadosNe[8].nome)
vetorVazio.splice(2, 0, estadosNe[5].nome)
vetorVazio.splice(3, 0, estadosNe[7].nome)
vetorVazio.splice(4, 0, estadosNe[3].nome)
vetorVazio.splice(5, 0, estadosNe[4].nome)
vetorVazio.splice(6, 0, estadosNe[6].nome)
vetorVazio.splice(7, 0, estadosNe[2].nome)

console.table(vetorVazio)